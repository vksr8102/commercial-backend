...
**Supported version of nodejs >= 20**,
**Supported version of mongoose >= 8**
...
```
- index.js file, exports platform routes, imported into index.js to access all the routes.
...
- If you are running test environment then test cases will run using test database,and its configuration is there inside index.js
